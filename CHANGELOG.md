...
- Project migrated to https://github.com/ewoks-kit/ewoksjob.

## [1.4.0] - 2025-12-30

### Changed

- Parse configuration URI's with `ewoksutils`.
- Depend on `ewoks >=4.0.0`.

## [1.3.4] - 2025-11-24

### Fixed

- Replace the `gevent` monkey patching done by `celery` because it causes
  the celery app to be instantiated during patching.
...
[1.3.2]: https://github.com/ewoks-kit/ewoksjob/compare/v1.3.1...v1.3.2
[1.3.1]: https://github.com/ewoks-kit/ewoksjob/compare/v1.3.0...v1.3.1
[1.3.0]: https://github.com/ewoks-kit/ewoksjob/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/ewoks-kit/ewoksjob/compare/v1.1.2...v1.2.0
[1.1.2]: https://github.com/ewoks-kit/ewoksjob/compare/v1.1.1...v1.1.2
[1.1.1]: https://github.com/ewoks-kit/ewoksjob/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/ewoks-kit/ewoksjob/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.7.0...v1.0.0
[0.7.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.6.1...v0.7.0
[0.6.1]: https://github.com/ewoks-kit/ewoksjob/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.5.0...v0.6.0
[0.5.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.3.3...v0.4.0
[0.3.3]: https://github.com/ewoks-kit/ewoksjob/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/ewoks-kit/ewoksjob/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/ewoks-kit/ewoksjob/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.5...v0.3.0
[0.2.5]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.4...v0.2.5
[0.2.4]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.3...v0.2.4
[0.2.3]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.2...v0.2.3
[0.2.2]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.1...v0.2.2
[0.2.1]: https://github.com/ewoks-kit/ewoksjob/compare/v0.2.0...v0.2.1
[0.2.0]: https://github.com/ewoks-kit/ewoksjob/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/ewoks-kit/ewoksjob/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/ewoks-kit/ewoksjob/-/tags/v0.1.0